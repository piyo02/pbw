...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'PBW User Registration';
            $this->load->view('templates/auth_header', $data);
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Your registration has been succesful. Please activate your account!</div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'prakPBW12@gmail.com',
            'smtp_pass' => 'praktikumpbw12',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('prakPBW12@gmail.com', 'Praktikum PBW');
